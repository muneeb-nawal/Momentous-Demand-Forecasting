...
def main_app():
    ...
    with st.expander("Update Spends for Marketing Channels", expanded=expand_spends):
        ...
        base_table = pd.DataFrame({
                        ...
                        'Spends_Meta': [
                            89951.74677, 
                            85000, 80000, 80000, 75000,
                            75000, 75000, 75000, 75000,
                            75000, 75000, 100000, 80000
                        ],
                        'Spends_Google': [
                            216934.3594, 
                            185000, 180000, 170000, 165000,
                            165000, 165000, 165000, 165000,
                            165000, 170000, 200000, 180000
                        ],
                        'Spends_Amazon': [
                            271956.4213, 
                            256781, 256781, 256781, 256781,
                            256781, 256781, 256781, 256781,
                            256781, 256781, 256781, 256781
                        ],
                        'Spends_Audio_SponCon': [
                            255314.9126, 
                            400000, 400000, 400000, 350000,
                            350000, 350000, 350000, 350000,
                            350000, 400000, 400000, 400000
                        ],
                        'Spends_partnerships': [
                            373054.7135, 
                            555000, 562000, 565250, 515250,
                            517750, 525250, 525250, 525250,
                            525250, 591750, 611750, 591750
                        ],
                        'Spends_Others': [
                            12903.22581, 
